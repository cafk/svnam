...
Release 0.6.0.12
    - fixed db query, add quotes arround db field with name "recursive"

Release 0.6.0.11
    - fixed bug in user list showing all users as admin users
    - fixed typo in html template
    - fixed user administration, password change uses now password policy of user instead
      of asdmin policy
